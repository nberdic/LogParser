    ...
    public class LogLevelFilterTests
    {
        ...
        public void Initiliaze()
        {
            listOfLines = new ObservableCollection<IModel> {
             ...
             new IModel { Id = 1, DateTime = new DateTime(2019, 1, 8, 23, 00, 55), ThreadId = "[00000005]", LogLevel = "SomethingLog", EventId = 1, Text = "Something2" },
             new IModel { Id = 1, DateTime = new DateTime(2019, 1, 8, 9, 30, 52), ThreadId = "[000000AA]", LogLevel = "Info3", EventId = 1, Text = "Something3" }};
