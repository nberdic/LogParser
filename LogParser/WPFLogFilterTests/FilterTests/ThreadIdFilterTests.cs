    ...
    public class ThreadIdFilterTests
    {
        ...
        public void Initiliaze()
        {
            listOfLines = new ObservableCollection<LogModel> {
             ...
             new LogModel { Id = 1, DateTime = new DateTime(2019, 1, 8, 23, 00, 55), ThreadId = "[00000005]", LogLevel = "Info", EventId = 1, Text = "Something2" },
             new LogModel { Id = 1, DateTime = new DateTime(2019, 1, 8, 9, 30, 52), ThreadId = "[000000AA]", LogLevel = "Info", EventId = 1, Text = "Something3" }};
